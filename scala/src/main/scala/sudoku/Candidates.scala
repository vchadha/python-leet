...
object Candidates {
  ...
  /** Constructor. Returns Empty if the set is blank.
    *
    * @param values
    *   Set of Filled values
    * @return
    *   If set is empty, return Empty, else NonEmpty containing input values
    */
  ...
  /** Remove a value, collapsing to Empty if needed
    *
    * @param candidates
    *   Candidates to remove from
    * @param value
    *   Value to remove
    * @return
    *   New set of candidates with value removed. Possibly empty.
    */
  ...
  /** Return size of candidates.
    *
    * @param candidates
    *   set of candidates to get size from
    * @return
    *   size of set. 0 if empty.
    */
